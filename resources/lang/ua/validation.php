...
return [
    ...
    */
    ...
    'gte' => [
        ...
        'file'    => 'Розмір файлу в полі :attribute повинен бути більше або дорівнювати :value Кілобайт(а).',
        'string'  => 'Кількість символів в полі :attribute повинна бути більше або дорівнювати :value.',
        'array'   => 'Кількість елементів в полі :attribute повинна бути більше або дорівнювати :value.',
    ],
    ...
    'lte' => [
        ...
        'file'    => 'Розмір файлу в полі :attribute повинен бути менше або дорівнювати :value Кілобайт(а).',
        'string'  => 'Кількість символів в полі :attribute повинна бути менше або дорівнювати :value.',
        'array'   => 'Кількість елементів в полі :attribute повинна бути менше або дорівнювати :value.',
    ],
    'max' => [
    ...
    'size'                 => [
        ...
        'file'    => 'Розмір файлу в полі :attribute повинен бути рівним :size Кілобайт(а).',
        'string'  => 'Кількість символів в полі :attribute повинна бути рівною :size.',
        'array'   => 'Кількість елементів в полі :attribute повинна бути рівною :size.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Наступні рядки використовуються для заміни програмних імен елементів
    | користувацького інтерфейсу на зручні для читання. Наприклад, замість імені
